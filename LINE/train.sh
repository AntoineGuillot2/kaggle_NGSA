...
./line -train net_youtube_dense.txt -output vec_1st_wo_norm.txt -binary 1 -size 56 -order 1 -negative 5 -samples 100 -threads 4
./line -train net_youtube_dense.txt -output vec_2nd_wo_norm.txt -binary 1 -size 56 -order 2 -negative 5 -samples 100 -threads 4
